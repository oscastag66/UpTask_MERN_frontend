...
const Proyecto = () => {
    ...
    const { obtenerProyecto, proyecto, cargando, handleModalTarea, 
            ...
            actualizaeTareaProyecto, cambiarEstadoTarea } = useProyectos()
    ...
    useEffect( () => {
        ...
        socket.on('tarea actualizada', (tareaActualizada) => {
            if(tareaActualizada.proyecto._id === proyecto._id) {
                actualizaeTareaProyecto(tareaActualizada)
            }
        })
          ...
          {admin && (
            ...
            {admin && (
                ...
                <div className='bg-white shadow mt-10 rounded-lg'>
                    ...
                    <p className='text-center my-5 p-10'>No hay claboradores en este proyecto</p> }
                </div>
                </>
            )}
